...
export const MONSTER_NAMES = new Map<number, string>([
  ...
  [TetuGame.MONSTERS.POSTAL_HEADMISTRESS_10, 'Postal Headmistress'],
  [TetuGame.MONSTERS.MOCK4, 'MOCK4'],

  [TetuGame.MONSTERS.HUNT_ESSENCE_35, 'Hunt Essence'],
  [TetuGame.MONSTERS.HUNT_ESSENCE_43, 'Hunt Essence'],
  [TetuGame.MONSTERS.GRAVE_KEEPERS_42, 'Grave Keepers'],
  [TetuGame.MONSTERS.CONVERTED_KNIGHT_34, 'Converted Knight'],
  [TetuGame.MONSTERS.CONVERTED_KNIGHT_42, 'Converted Knight'],
  [TetuGame.MONSTERS.CONVERTED_ARISTOCRAT_43, 'Converted Aristocrat'],
  [TetuGame.MONSTERS.MEAT_DANCER_42, 'Meat Dancer'],
  [TetuGame.MONSTERS.GRAVE_PARASITE_42, 'Grave Parasite'],
  [TetuGame.MONSTERS.SNIDE_CORPSE_EATER_35, 'Snide Corpse-Eater'],
  [TetuGame.MONSTERS.SNIDE_CORPSE_EATER_43, 'Snide Corpse-Eater'],
  [TetuGame.MONSTERS.HIGH_PRIESTESS_DAERHANNA_3, 'High Priestess Daerhanna'],
  [TetuGame.MONSTERS.THRALLS_NIGHTMARE_10, "Thrall's Nightmare"],
  [TetuGame.MONSTERS.EVIL_MIDGETS_34, 'Evil Midgets'],
  [TetuGame.MONSTERS.EVIL_MIDGETS_44, 'Evil Midgets'],
  [TetuGame.MONSTERS.STREET_ROBBER_44, 'Street Robber'],
  [TetuGame.MONSTERS.DESPERATE_DESERTER_34, 'Desperate Deserter'],
  [TetuGame.MONSTERS.DESPERATE_DESERTER_44, 'Desperate Deserter'],
  [TetuGame.MONSTERS.THRALL_OWNER_45, 'Thrall Owner'],
  [TetuGame.MONSTERS.WASTEWATER_LEECH_44, 'Wastewater Leech'],
  [TetuGame.MONSTERS.CACTUS_MAN_45, 'Cactus Man'],
  [TetuGame.MONSTERS.BLACK_HORDE_35, 'Black Horde'],
  [TetuGame.MONSTERS.BLACK_HORDE_45, 'Black Horde'],
  [TetuGame.MONSTERS.PRIOR_BABADZAKI_TUMBLEWEED_3, 'Prior Babadzaki Tumbleweed'],
  [TetuGame.MONSTERS.ENSLAVED_DEMOLDER_10, 'Enslaved Demolder'],
  [TetuGame.MONSTERS.FUGITIVE_DEMOLDER_10, 'Fugitive Demolder'],
  [TetuGame.MONSTERS.SHOCKERFACE_10, 'Shockerface'],
  [TetuGame.MONSTERS.BATTLE_THRALL_10, 'Battle Thrall'],
  [TetuGame.MONSTERS.TROLL_WARLORD_10, 'Troll Warlord'],
  [TetuGame.MONSTERS.REJECTED_ESSENCE_10, 'Rejected Essence'],
  [TetuGame.MONSTERS.GUARDIAN_THUG_10, 'Guardian Thug'],
  [TetuGame.MONSTERS.BELLBOY_46, 'Bellboy'],
  [TetuGame.MONSTERS.RICH_DEADBEATS_35, 'Rich Deadbeats'],
  [TetuGame.MONSTERS.RICH_DEADBEATS_47, 'Rich Deadbeats'],
  [TetuGame.MONSTERS.DOUBLE_DELIGHT_35, 'Double Delight'],
  [TetuGame.MONSTERS.DOUBLE_DELIGHT_47, 'Double Delight'],
  [TetuGame.MONSTERS.DISCARDED_TOY_47, 'Discarded Toy'],
  [TetuGame.MONSTERS.HIGHBORN_REBEL_46, 'Highborn Rebel'],
  [TetuGame.MONSTERS.SAWMILL_KNIGHT_34, 'Sawmill Knight'],
  [TetuGame.MONSTERS.SAWMILL_KNIGHT_46, 'Sawmill Knight'],
  [TetuGame.MONSTERS.KING_ARCHIBALD_DICKSTRONG_3, 'King Archibald Dickstrong'],
  [TetuGame.MONSTERS.ROYAL_HORSE_47, 'Royal Horse'],
]);
...
const ITEMS_NAMES = new Map<string, string>([
  ...
  ['SACRA_BODY_12_ITEM', 'Tunic of Sacrifice'],
  ['SACRA_GLOVES_12_ITEM', 'Protective Red Thread'],
  ['SACRA_CONS_36_ITEM', 'Spicy Tomato Soup'],
  ['SACRA_CONS_37_ITEM', 'Blue Jelly'],
  ['SACRA_CONS_38_ITEM', 'Flammable Grease'],
  ['SACRA_CONS_39_ITEM', 'Poison Grease'],
  ['SACRA_CONS_40_ITEM', 'Fairy Magic Powder'],
  ['SACRA_CONS_41_ITEM', 'Pipe Of Fragrant Tobacco'],
  ['SACRA_CONS_43_ITEM', 'Resonating Blood Tear'],
  ['SACRA_HELM_10_ITEM', 'Jester Cap'],
  ['SACRA_HELM_11_ITEM', 'Mourning Veil'],
  ['SACRA_BODY_9_ITEM', 'Jester Jacket'],
  ['SACRA_BODY_10_ITEM', 'Idle Gulp'],
  ['SACRA_BODY_11_ITEM', 'Priest-Digger Tunic'],
  ['SACRA_GLOVES_9_ITEM', 'Jester Gloves'],
  ['SACRA_GLOVES_10_ITEM', 'Hard Leather Gloves'],
  ['SACRA_GLOVES_11_ITEM', 'Crab Claws'],
  ['SACRA_BELT_6_ITEM', 'Carnival Waistwrap'],
  ['SACRA_BELT_7_ITEM', 'Iron Plate Belt'],
  ['SACRA_AMULET_14_ITEM', 'Teddy Bear '],
  ['SACRA_AMULET_15_ITEM', 'Suspiria'],
  ['SACRA_AMULET_16_ITEM', 'Golden Shiny'],
  ['SACRA_AMULET_17_ITEM', "Bruria's Underwear"],
  ['SACRA_RING_12_ITEM', "King's Ring"],
  ['SACRA_RING_13_ITEM', 'Protective Ring'],
  ['SACRA_RING_14_ITEM', 'Azure Flow Ring'],
  ['SACRA_OFF_14_ITEM', 'Panzerbrecher'],
  ['SACRA_OFF_15_ITEM', 'Blinding Dust'],
  ['SACRA_OFF_16_ITEM', 'Charged Demon Stone'],
  ['SACRA_BOOTS_8_ITEM', 'Jester Boots'],
  ['SACRA_BOOTS_9_ITEM', "Smuggler's Heavy Boots"],
  ['SACRA_BOOTS_10_ITEM', 'Deluxe Sandals'],
  ['SACRA_BOOTS_11_ITEM', 'Gladiator Foot Shields'],
  ['SACRA_OHW_15_ITEM', 'Goedendag'],
  ['SACRA_OHW_16_ITEM', "Bandit's Сleaver"],
  ['SACRA_OHW_17_ITEM', 'Light Rapier'],
  ['SACRA_OHW_18_ITEM', 'Pocket Crossbow'],
  ['SACRA_OHW_19_ITEM', 'Scarlet Branch Battle Staff'],
  ['SACRA_THW_12_ITEM', 'Longbow'],
  ['SACRA_THW_13_ITEM', "City Guard's Halberd"],
  ['SACRA_THW_14_ITEM', 'Bone Sword'],
  ['SACRA_THW_16_ITEM', 'Kropatch'],
  ['SACRA_HEAD_OFF_ITEM', 'Head off!'],
  ['SACRA_VOICE_OF_DEAD_GOD_ITEM', 'Voice of a Dead God'],
  ['SACRA_FAST_ROLL_ITEM', 'Fast Roll'],
  ['SACRA_MEATGRINDER_ITEM', 'Meatgrinder'],
  ['SACRA_DEMOLDERS_TOUGHNESS_ITEM', "Demolders' Toughness"],
  ['SACRA_PYROMANIAC_ITEM', 'Pyromaniac'],
  ['SACRA_BLAST_ITEM', 'Blast'],
  ['SACRA_HORSEBREAKER_ITEM', 'Horsebreaker'],
  ['SACRA_FIRE_POT_ITEM', 'Fire Pot'],
]);
